...
class m_laporan_stok_gudang extends CI_Model {
    ...
    var $order 				= array('nama_perbekalan_produk' => 'asc', 'nama_kelompok_produk' => 'asc',
									'nama_golongan_produk' => 'asc', 'nama_jenis_produk' => 'asc', 'nama_produk' => 'asc'); // default order	
