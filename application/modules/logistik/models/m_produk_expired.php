...
class m_produk_expired extends CI_Model {
	
	var $table_supplier					= 'ck_supplier';
	var $tbl_stok						= 'ck_stok';
	
	var $view_produk_exp				= 'ck_view_logistik_produk_expired';
	...
	var $column_order 					= array(null, 'id_produk', 'nama_produk', 'nama_kemasan', 'nama_satuan', 
												'stok', 'batch_number', 'expired_date', 'id_supplier',
												'nama_supplier', 'selisih_bulan', 'selisih_hari'); // set column field database for datatable orderable
	...
	private function _get_datatables_query() {
		...
		$this->db->from($this->view_produk_exp);
