...
<script>
	$(document).ready(function() {		
		$('#table_data').DataTable({
			...
			"bServerSide": true,
			"sServerMethod": "GET",
			"sAjaxSource": "logistik/quarantine/get_data",
			"iDisplayLength": 10,
			...
			"aoColumns": [
				...
				{ "bVisible": true, "bSearchable": true, "bSortable": true }, // Keterangan 3
...
<div class="modal fade" id="modal-primary" tabindex="-1" role="dialog" aria-labelledby="modal-primary-header">                        
	<div class="modal-dialog modal-primary" role="document">
		...
		<form method="POST" action="logistik/quarantine/create_header" class="form-horizontal">
