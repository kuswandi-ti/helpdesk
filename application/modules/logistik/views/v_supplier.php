...
<script>
	$(document).ready(function() {
		$('#table_data').DataTable({
			...
			"bServerSide": true,
			"sServerMethod": "GET",
			"sAjaxSource": "logistik/supplier/get_data",
			"iDisplayLength": 10,
		...
		$(".btn-tambah").click(function() {
			$('#modal-primary-header').html('Tambah Data Supplier');
			reset_input();
		});
		...
		$("body").on("click", "#table_data .btn-edit", function() {
			...
			$.ajax({
				url : 'logistik/supplier/supplier_view',
				type: 'POST',
				data: {
					id: id
				},
				...
				success : function(data) {
					...
					$('#modal-primary-header').html('Edit Data Supplier');
		...
		$(".add-edit").click(function(e) {			
			...
			if ($('#txtid').val() == '') {
				var urls = 'logistik/supplier/supplier_create';
			} else {
				var urls = 'logistik/supplier/supplier_update';
			}
		...
		$("body").on("click", "#table_data .btn-alamat", function() {
			...
			window.open('logistik/supplier_alamat/?sid='+id, '_blank');
		});
	});
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-10">
									...
									<input type="text" name="txtnama" id="txtnama" class="form-control" placeholder="Nama Supplier" required>
								</div>
							</div>
							<div class="form-group">
