...
<script>
	$(document).ready(function() {
		...
		$("#simpan_header").click(function() {
			...
			$.ajax({
				url: 'logistik/perencanaan_pembelian/update_header',
				data: {
				...
				success: function(data) {
					if (data == 'done')
						window.location = "logistik/perencanaan_pembelian";
				}
			});
		});
		...
		$("#simpan_detail").click(function() {
			...
			$.ajax({
				url: 'logistik/perencanaan_pembelian/update_item_detail',
				data: {
	...
	function detail_list() {
        ...
        $.ajax({
            url   : 'logistik/perencanaan_pembelian/detail_list/?hid='+hid,
            async : false,
            success : function(data) {
	...
	$("body").on("click", "#submit_detail", function() {
		...
		$.ajax({			
			url: "logistik/perencanaan_pembelian/create_detail",
			data: {   
	...
	$("body").on("click", "#table_detail #hapus_detail", function() {
		...
		if (del == true) {
			$.ajax({
				url: 'logistik/perencanaan_pembelian/delete_item_detail',
				type: 'post',
				data: {
