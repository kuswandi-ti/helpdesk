...
<script>
	$(document).ready(function() {
		$('#table_data').DataTable({
			...
			"bServerSide": true,
			"sServerMethod": "GET",
			"sAjaxSource": "logistik/bentuk_sediaan/get_data",
			"iDisplayLength": 10,
			...
			"aoColumns": [
				...
				{ "bVisible": true, "bSearchable": true, "bSortable": true }, // Nama Perbekalan 3
		...
		$("body").on("click", "#table_data .btn-edit", function() {
			...
			$.ajax({
				url : 'logistik/bentuk_sediaan/bentuk_sediaan_view',
				type: 'POST',
				data: {
					id: id
				},
				...
				success : function(data) {
					...
					$('#txtnama_edit').val(data.nama_bentuk_sediaan);
...
<div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="modal-primary-header">                        
	<div class="modal-dialog modal-primary" role="document">
		...
		<form id="form-create" method="POST" action="logistik/bentuk_sediaan/bentuk_sediaan_create">
			<div class="modal-content">
				<div class="modal-header">                        
					<h4 class="modal-title" id="modal-primary-header">Tambah Data Bentuk Sediaan Produk</h4>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<label>Nama</label>
							<input type="text" name="txtnama_add" id="txtnama_add" class="form-control" placeholder="Nama Bentuk Sediaan Produk" required>
						</div>
					</div>
					&nbsp;
					<div class="row">
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="modal-primary-header">                        
	<div class="modal-dialog modal-primary" role="document">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" class="icon-cross"></span></button>
		<form id="form-edit" method="POST" action="logistik/bentuk_sediaan/bentuk_sediaan_update">
			<div class="modal-content">
				<div class="modal-header">                        
					<h4 class="modal-title" id="modal-primary-header">Ubah Data Bentuk Sediaan Produk</h4>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
