 <script>
  $(document).ready(function(){
    ...
    function update(id){
		$.ajax({
            url : '<?php echo base_url();?>index.php/region/region_view/' + id,
            type: "POST",
    ...
    $('.delete').button().click(function (){
        ...
        $.ajax({
            url : '<?php echo base_url();?>index.php/region/region_delete/' + id,
            type: "POST",
            success : function(result){
              var data=jQuery.parseJSON(result);
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="form_create" class="form-horizontal" action="region/region_create" method="POST">
                                <input type="hidden" name="created_by" value="<?php echo $data['user_name'];?>">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Kode <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input type="text" name="kode" required="required" class="form-control col-md-7 col-xs-12" maxlength="2">
                                    </div>
                                  </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Nama Region <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
								  ...
								  <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="alamat">Deskripsi
                                  </label>
                                  	<div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="modal fade" id="update-form" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <form id="form_update" class="form-horizontal" action="region/region_update" method="POST">
                                <input type="hidden" name="created_by" value="<?php echo $data['user_name'];?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input type="text" name="kode" id="kode" required="required" class="form-control col-md-7 col-xs-12" maxlength="2" disabled>
                                    </div>
                                  </div>
                                 <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Nama Region <span class="required">*</span>
                              ...
                              <?php 
								if(sizeof($data['region']) != 0)
                                {
                                  ...
                                  { 
									...
									echo '<tr>';
                                    echo '<td>'.$no.'</td>';
                                    echo '<td>'.$data['region'][$i]->kode.'</td>';
                                    echo '<td>'.$data['region'][$i]->nama.'</td>';
                                    echo '<td>'.$data['region'][$i]->deskripsi.'</td>';
                                    echo '<td class="text-center">';
                                    echo '<button value="'.$data['region'][$i]->id.'" id="btn_'.$i.'" class="update btn btn-labeled btn-success" title="Ubah"><i  class="glyphicon glyphicon-pencil"></i></button>';
                                    echo '<button value="'.$data['region'][$i]->id.'" id="btn_'.$i.'" class="del btn btn-labeled btn-danger" title="Hapus"><i class="glyphicon glyphicon-remove"></i></button>';
                                    echo '</td>';
                                    echo '</tr>';
                                  }
                                ...
                                {
                                  echo '<div class="alert alert-info text-center"><strong>Tidak terdapat region</strong></div>';
                                }
                              ?>
                  </div>
                </div>
