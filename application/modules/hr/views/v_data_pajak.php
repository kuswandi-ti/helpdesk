...
<script>
	$(document).ready(function() {
		$('#table_data').DataTable({
			...
			"bServerSide": true,
			"sServerMethod": "GET",
			"sAjaxSource": "hr/data_pajak/get_data",
			"iDisplayLength": 10,
		...
		$("body").on("click", "#table_data .btn-edit", function() {
			...
			$.ajax({
				url : 'hr/data_pajak/data_pajak_view',
				type: 'POST',
				data: {
					id: id
				},
...
<div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="modal-primary-header">                        
	<div class="modal-dialog modal-primary" role="document">
		...
		<form id="form-create" method="POST" action="hr/data_pajak/data_pajak_create">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="modal-primary-header">Tambah Data Pajak</h4>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<label>Nama Pajak</label>
							<input type="text" name="txtnama_add" id="txtnama_add" class="form-control" placeholder="Nama Pajak" required>
						</div>
					</div>
				</div>
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="modal-primary-header">                        
	<div class="modal-dialog modal-primary" role="document">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" class="icon-cross"></span></button>
		<form id="form-edit" method="POST" action="hr/data_pajak/data_pajak_update">
			<div class="modal-content">
				<div class="modal-header">                        
					<h4 class="modal-title" id="modal-primary-header">Ubah Data Pajak</h4>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							...
							<input type="text" name="txtnama_edit" id="txtnama_edit" class="form-control" placeholder="Nama Pajak" required>
						</div>
					</div>
				</div>
				<div class="modal-footer">
