	...
	<div class="col-md-12">
		<div class="app-heading app-heading-small">
			...
			<div class="heading-elements">
				<button type="button" class="btn btn-info btn-icon-fixed btn-tambah" data-toggle="modal" data-target="#modal-primary"><span class="icon-file-add"></span> Buat Pengajuan Pembayaran Baru</button>     
			</div>
		</div>                                                         
	</div>
</div>
...
<div class="modal fade" id="modal-primary" tabindex="-1" role="dialog" aria-labelledby="modal-primary-header">                        
	<div class="modal-dialog modal-primary" role="document">
		...
		<form method="POST" action="pembelian/pengajuan_pembayaran/create_header">
