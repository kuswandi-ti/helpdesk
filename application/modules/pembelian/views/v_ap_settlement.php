	...
	<div class="col-md-12">
		<div class="app-heading app-heading-small">
			...
			<div class="heading-elements">
				<button type="button" class="btn btn-info btn-icon-fixed btn-proses-settlement" data-toggle="modal" data-target="#modal-primary"><span class="icon-power"></span> Proses Settlement</button>     
			</div>
		</div>                                                         
	</div>
</div>
