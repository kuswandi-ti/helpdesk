	...
	<div class="col-md-12">
		<div class="app-heading app-heading-small">
			...
			<div class="heading-elements">
				<button type="button" class="btn btn-info btn-icon-fixed btn-tambah" data-toggle="modal" data-target="#modal-primary"><span class="icon-file-add"></span> Buat Penerimaan Tagihan Baru</button>     
			</div>
		</div>                                                         
	</div>
</div>
...
<div class="modal fade" id="modal-primary" tabindex="-1" role="dialog" aria-labelledby="modal-primary-header">                        
	<div class="modal-dialog modal-primary" role="document">
		...
		<form method="POST" action="pembelian/penerimaan_tagihan/create_header">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-4">
							...
							<input type="text" name="txtnoinvoicesupplier" id="txtnoinvoicesupplier" class="form-control" placeholder="No. invoice Supplier">
						</div>
						<div class="col-md-4">
							<label>Tgl. Invoice Supplier</label>
							<input type="text" name="txttglinvoicesupplier" id="txttglinvoicesupplier" class="form-control" value="<?php echo date($this->config->item('FORMAT_DATE_TO_DISPLAY')); ?>">
						</div>
						<div class="col-md-4">
							<label>Tgl. Jatuh Tempo</label>
							<input type="text" name="txttgljatuhtempo" id="txttgljatuhtempo" class="form-control" value="<?php echo date($this->config->item('FORMAT_DATE_TO_DISPLAY')); ?>">
						</div>
					</div>
					&nbsp;
					<div class="row">
